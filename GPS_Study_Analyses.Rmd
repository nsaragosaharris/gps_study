...
max_age <- max(round(shortdata$Age),na.rm = TRUE)
min_age <- min(round(shortdata$Age),na.rm = TRUE)
...
# Use glmmTMB to estimate zero-inflated model with poisson family distribution.
...
# We are using robust regression to account for the potential effect of outliers on the estimates.
...
AIC(group_entropy_robust_standardized)
AIC(linear_age_entropy_robust_standardized)
AIC(Quadratic_Age_Z_Entropy_robust_standardized)
...
summary(PosAffect_RE_AgeGroup_controls)
...
f.robftest(group_phone_text_entropy_robust, var = "Group2")
stats::confint.default(object = group_phone_text_entropy_robust, parm = "Group2", level = 0.95)

f.robftest(group_phone_text_entropy_robust, var = "Daily_RE_Mean_Z:Group2")
...
f.robftest(linear_age_phone_text_entropy_robust, var = "Age_Z")
stats::confint.default(object = linear_age_phone_text_entropy_robust, parm = "Age_Z", level = 0.95)

f.robftest(linear_age_phone_text_entropy_robust, var = "Daily_RE_Mean_Z:Age_Z")
...
f.robftest(CARE_entropy_age_group, var = "Daily_RE_Mean_Z")
stats::confint.default(object = CARE_entropy_age_group, parm = "Daily_RE_Mean_Z", level = 0.95)

f.robftest(CARE_entropy_age_group, var = "Group2")
stats::confint.default(object = CARE_entropy_age_group, parm = "Group2", level = 0.95)

f.robftest(CARE_entropy_age_group, var = "Daily_RE_Mean_Z:Group2")
